...
<h2 className="dash-heading">Product return form</h2>
 ...
 <div className="steps-container">
      ...
      <div style={{width: 18.17, height: 18.17, background: 'rgba(54, 181, 129, 0.61)', borderRadius: 9999}} />
<div style={{width: 18.17, height: 18.17, background: 'rgba(54, 181, 129, 0.61)', borderRadius: 9999}} />
<div style={{width: 18.17, height: 18.17, background: 'rgba(54, 181, 129, 0.61)', borderRadius: 9999}} />
<div style={{width: 18.17, height: 18.17, background: 'rgba(54, 181, 129, 0.61)', borderRadius: 9999}} />
<div style={{width: 18.17, height: 18.17, background: 'rgba(54, 181, 129, 0.61)', borderRadius: 9999}} />
<div style={{width: 18.17, height: 18.17, background: 'rgba(54, 181, 129, 0.61)', borderRadius: 9999}} />
<div style={{color: 'rgba(38.97, 141.60, 99.58, 0.99)', fontSize: 11, fontFamily: 'Poppins', fontWeight: '600', wordWrap: 'break-word'}}>1</div>
<div style={{color: 'rgba(38.97, 141.60, 99.58, 0.99)', fontSize: 11, fontFamily: 'Poppins', fontWeight: '600', wordWrap: 'break-word'}}>2</div>
<div style={{color: 'rgba(38.97, 141.60, 99.58, 0.99)', fontSize: 11, fontFamily: 'Poppins', fontWeight: '600', wordWrap: 'break-word'}}>3</div>
<div style={{color: 'rgba(38.97, 141.60, 99.58, 0.99)', fontSize: 11, fontFamily: 'Poppins', fontWeight: '600', wordWrap: 'break-word'}}>4</div>
<div style={{color: 'rgba(38.97, 141.60, 99.58, 0.99)', fontSize: 11, fontFamily: 'Poppins', fontWeight: '600', wordWrap: 'break-word'}}>5</div>
<div style={{color: 'rgba(38.97, 141.60, 99.58, 0.99)', fontSize: 11, fontFamily: 'Poppins', fontWeight: '600', wordWrap: 'break-word'}}>6</div>
<div style={{width: 18.17, height: 18.17, background: 'rgba(54, 181, 129, 0.61)', borderRadius: 9999}} />
<div style={{color: 'rgba(38.97, 141.60, 99.58, 0.99)', fontSize: 11, fontFamily: 'Poppins', fontWeight: '600', wordWrap: 'break-word'}}>7</div>
