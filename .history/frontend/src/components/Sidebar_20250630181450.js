...
import { FaBars, FaTimes, FaHome, FaUsers, FaEye, FaFileAlt, FaCog, FaSignOutAlt, FaQuestionCircle } from "react-icons/fa";
import "./Sidebar.css";
import { ReactComponent as Walmart } from './walmart icon.svg';
function Sidebar({ collapsed, toggleSidebar, onNavigate, currentPage, onLogout }) {
  const menuItems = [
  ...
  return (
    <div className={`sidebar ${collapsed ? "collapsed" : ""}`}>
      ...
      <div className="top-section">
       {!collapsed && <Walmart className="logo" />}
      ...
      <div className="bottom-section">
        {!collapsed && (
          <>
            ...
            <ul>
              <li><FaSignOutAlt /><button className="logout-btn-2" onClick={onLogout}>Logout</button></li>
