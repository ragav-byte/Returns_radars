...
import mobileScreenError from '../assets/mobile_screen_error.png';
  ...
  return (
    <div className="admin-container">
      ...
      <div className="mobile">
        <p>The details cannot be shown in smaller screens(300px to 650px)</p>
       <img src={mobileScreenError} alt="Mobile screen error" />
      </div>
    </div>
  );
}
