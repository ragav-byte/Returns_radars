...
<h2 className="dash-heading">Product return form</h2>
 ...
 <div className="steps-container">
      <h2 className="steps-heading">📦 How to Submit a Return</h2>
      <div style="width: 18.17px; height: 18.17px; background: rgba(54, 181, 129, 0.61); border-radius: 9999px"></div>
<div style="width: 18.17px; height: 18.17px; background: rgba(54, 181, 129, 0.61); border-radius: 9999px"></div>
<div style="width: 18.17px; height: 18.17px; background: rgba(54, 181, 129, 0.61); border-radius: 9999px"></div>
<div style="width: 18.17px; height: 18.17px; background: rgba(54, 181, 129, 0.61); border-radius: 9999px"></div>
<div style="width: 18.17px; height: 18.17px; background: rgba(54, 181, 129, 0.61); border-radius: 9999px"></div>
<div style="width: 18.17px; height: 18.17px; background: rgba(54, 181, 129, 0.61); border-radius: 9999px"></div>
<div style="color: rgba(38.97, 141.60, 99.58, 0.99); font-size: 11px; font-family: Poppins; font-weight: 600; word-wrap: break-word">1</div>
<div style="color: rgba(38.97, 141.60, 99.58, 0.99); font-size: 11px; font-family: Poppins; font-weight: 600; word-wrap: break-word">2</div>
<div style="color: rgba(38.97, 141.60, 99.58, 0.99); font-size: 11px; font-family: Poppins; font-weight: 600; word-wrap: break-word">3</div>
<div style="color: rgba(38.97, 141.60, 99.58, 0.99); font-size: 11px; font-family: Poppins; font-weight: 600; word-wrap: break-word">4</div>
<div style="color: rgba(38.97, 141.60, 99.58, 0.99); font-size: 11px; font-family: Poppins; font-weight: 600; word-wrap: break-word">5</div>
<div style="color: rgba(38.97, 141.60, 99.58, 0.99); font-size: 11px; font-family: Poppins; font-weight: 600; word-wrap: break-word">6</div>
<div style="width: 18.17px; height: 18.17px; background: rgba(54, 181, 129, 0.61); border-radius: 9999px"></div>
<div style="color: rgba(38.97, 141.60, 99.58, 0.99); font-size: 11px; font-family: Poppins; font-weight: 600; word-wrap: break-word">7</div>
