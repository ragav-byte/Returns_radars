...
useEffect(() => {
  ...
  <div className="product-info-box">
    <p className="prod-name-text"><strong>Name:</strong> {productInfo.name}</p>
    <p className="prod-name-specs"><strong>Specs:</strong> {productInfo.specs}</p>
    <img className="prod-name-text" src={productInfo.url}></img>
  </div>
)}
    </div>
